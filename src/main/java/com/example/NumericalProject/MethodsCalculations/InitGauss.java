...
public class InitGauss {
    ...
    public void gauss() {
        ...
        A = new BigDecimal[][]{{BigDecimal.valueOf(0), BigDecimal.valueOf(0), BigDecimal.valueOf(0), BigDecimal.valueOf(0)},
                {BigDecimal.valueOf(0), BigDecimal.valueOf(1), BigDecimal.valueOf(1), BigDecimal.valueOf(-1)},
                {BigDecimal.valueOf(0), BigDecimal.valueOf(6), BigDecimal.valueOf(2), BigDecimal.valueOf(2)},
                {BigDecimal.valueOf(0), BigDecimal.valueOf(-3), BigDecimal.valueOf(4), BigDecimal.valueOf(1)}};
        B = new BigDecimal[]{BigDecimal.valueOf(0), BigDecimal.valueOf(-3), BigDecimal.valueOf(2), BigDecimal.valueOf(1)};
